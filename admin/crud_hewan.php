...
<div class="container mx-auto px-6 py-10">
    ...
    <?php if (isset($_SESSION['flash_message'])): ?>
        <div class="mb-6 bg-green-100 border border-green-300 text-green-700 px-6 py-4 rounded-lg shadow-md">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md overflow-x-auto">
        <table class="min-w-full border-collapse border border-gray-300">
            ...
            <tbody>
                ...
                <tr class="border-t text-center">
                    ...
                    <td class="p-2 border">
                        <?php if (!empty($row['gambar'])): ?>
                            <img src="../uploads/<?= htmlspecialchars($row['gambar']); ?>" alt="Gambar Hewan" class="h-20 w-20 object-cover rounded-md mx-auto">
                        <?php else: ?>
                ...
                ?>
                <tr>
                    <td colspan="8" class="text-center py-4 text-gray-500">Belum ada data hewan.</td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
